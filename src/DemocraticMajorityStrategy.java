...
/**
 * The DemocraticMajorityStrategy class implements a voting strategy where the majority of voters vote for the Democratic party.
 */
public class DemocraticMajorityStrategy implements VotingStrategy {
